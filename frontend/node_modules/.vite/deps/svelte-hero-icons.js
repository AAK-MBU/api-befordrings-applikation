...
function Icon($$anchor, $$props) {
  ...
  legacy_pre_effect(
    () => (deep_read_state(src()), deep_read_state(solid()), deep_read_state(mini()), deep_read_state(micro())),
    () => {
      set(icon, src()?.[solid() ? "solid" : mini() ? "mini" : micro() ? "micro" : "default"]);
    }
  );
  legacy_pre_effect_reset();
  ...
  add_svelte_meta(
    () => each(svg, 5, () => (get(icon), untrack(() => get(icon)?.path ?? [])), index, ($$anchor2, a) => {
      var path = root_1();
      attribute_effect(path, () => ({ ...get(a) }));
      append($$anchor2, path);
    }),
    "each",
    Icon,
...
//# sourceMappingURL=svelte-hero-icons.js.map
